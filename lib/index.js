...
var ScrollBehavior = function () {
  function ScrollBehavior(_ref) {
    ...
    this._onTimedWindowScroll = function () {
      /*
       ...
       * called.
       */
      if ((0, _utils.isMobileSafari)()) {
        setTimeout(_this._onWindowScroll.bind(_this, window.location.pathname), 500);
      } else {
        _this._onWindowScroll();
      }
    };

    this._onWindowScroll = function (pathname) {
      /*
    ...
    (0, _on2.default)(window, 'scroll', this._onTimedWindowScroll);
  ...
  ScrollBehavior.prototype.stop = function stop() {
    ...
    (0, _off2.default)(window, 'scroll', this._onTimedWindowScroll);
